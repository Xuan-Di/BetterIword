...
public class TranslateApi {
    ...
    private static final String APP_KEY = "0d2cbd0f7746ec57";

    private static final String APP_SECRET = "wwwuXa7AVlgKO9KIjXS56JHAs0NgD7sr";
    ...
    public static String requestForHttp(String url, Map<String, String> params) throws IOException {
        ...
        try {
            ...
            if ("audio/mp3".equals(contentType[0].getValue())) {
                ...
                JsonArray jsonArray = jsonObject.get("translation").getAsJsonArray();
                if(jsonArray.size()!=0){
